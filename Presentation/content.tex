...
\begin{frame}{Оценка распараллеливания}
...
%	\hline
%	\end{tabular}
%	\caption{\label{tab:OpenMP} Объёмы матриц телопроводности и жёсткости на разных сетках}
%\end{table}
\end{frame}
...
\begin{gather*}
    ...
    i = 2, 4, 6, 8.
\end{gather*}
Классический базис получаем при $s = -1 / 3$. Минимальный след матрицы оценим
\begin{gather*}
...
\begin{table}
	\begin{tabular}{|c|c|c|c|}
		\hline
		$p_1$ & Без предобуславливания & ILLT$\left( \widehat{\textbf{K}}^L \right)$ & ILLT$\left( \widehat{\textbf{K}}^L \right)$ + $T_0$ \\
		\hline
		0.75 & 7406 & 4230 & 3996 \\
		0.5  & 6186 & 3458 & 3240 \\
		0.25 & 3991 & 2446 & 2397 \\
...
\end{table}
ILLT$\left( \widehat{\textbf{K}}^L \right)$ --- неполное разложение Холецкого классической матрицы;
...
\begin{minipage}{0.59\textwidth}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
		\end{tabular}
		\caption{Максимальный уровень напряжения $\overline{\sigma}_{11}$ при вариации отношения длин полуосей $\rho$ и весового параметра $p_1$, где $\overline{r} = 0.05$}
		\label{tab:MaxStress}
	\end{table}
\end{minipage}
\begin{minipage}{0.39\textwidth}
	\begin{figure}
		...
		(б)
		\caption{Распределение деформации в локальном и нелокальном случаях}
