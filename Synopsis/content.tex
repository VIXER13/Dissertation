...
\underline{В разделе 2.2} описан способ аппроксимации уравнений стационарной теплопроводности (\ref{eq:StationaryHeatEquation}) и равновесия (\ref{eq:EquilibriumEquation}), а также приведена последовательность преобразований после которых приходим к системам линейных алегбраических уравнений (СЛАУ) соответствующим уравнению стационарной теплопроводности и уравнению равновесия
\begin{gather}
...
\begin{figure}[ht]
    \centerfloat{
        \includegraphics[width=0.5\textwidth]{pics/ApproxSQ.pdf}
    }
...
\begin{figure}[ht]
    \centerfloat{
        \includegraphics[width=0.5\textwidth]{pics/NonLocFEMSchema.pdf}
    }
...
\begin{figure}[ht]
    \centerfloat{
        \includegraphics[width=0.5\textwidth]{pics/ApproxSE.pdf}
    }
...
\begin{figure}[ht]
    \centerfloat{
        \includegraphics[width=0.5\textwidth]{pics/EllipseStress.pdf}
    }
...
\begin{figure}[ht]
    \centerfloat{
        \includegraphics[width=0.5\textwidth]{pics/EllipseThermal.pdf}
    }
